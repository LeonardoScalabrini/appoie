...
public class SenderEmail {
	...
	private MandrillMessageStatus[] messageStatusReports;
	...
	public void sendSenha(String senha) throws MandrillApiError, IOException {
		...
		msg.setFromEmail(fromEmail.toString());
		msg.setFromName(fromName.toString());
		...
		setMessageStatusReports(mandrillApi.messages().send(msg, false));
	}
	...
	public MandrillMessageStatus[] getMessageStatusReports() {
		return messageStatusReports;
	}

	public void setMessageStatusReports(MandrillMessageStatus[] messageStatusReports) {
		this.messageStatusReports = messageStatusReports;
	}
